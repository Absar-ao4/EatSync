    ...
    public List<McpToolStatusDto> getMcpStatus() {
        return List.of(
                ...
                new McpToolStatusDto(
                        "search_restaurants",
                        "TESTED",
                        "Successfully tested through VS Code MCP. Response structure is known and mapped to FoodRestaurantDto."
                ),
                new McpToolStatusDto(
                        "get_restaurant_menu",
                        "TESTED",
                        "Successfully tested through VS Code MCP. Returns restaurant details, categories and compact menu item data."
                ),
                new McpToolStatusDto(
                        "search_menu",
                        "TESTED",
